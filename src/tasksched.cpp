...
Task T_test(5000, TASK_FOREVER, &TestTask, &runner, false);
Task T_MotionDetect(1000, TASK_FOREVER, &MotionDetect, &runner, false);
Task T_MildSiren(2000, TASK_FOREVER, &MildSiren, &runner, false);